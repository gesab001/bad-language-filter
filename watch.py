...
if position_bible=="6":
  ...
  position_movie = "6"  
bible_style = ":force_style='Alignment="+position_bible+",Fontsize="+fontSize+"'"
movie_style = ":force_style='Alignment="+position_movie+",Fontsize="+fontSize+"'"
...
subprocess.call(convert_movie_assfile, shell=False)
...
subprocess.call(convertoass, shell=False)
