...
f.write(filter_text)
f.close()
command += "ffmpeg -i " + movietitle + ".mp4 -filter_complex_script 'filter.txt' -vf subtitles="+movietitle+"-filtered.srts:force_style='Alignment=6' "+ movietitle + "-filtered.mp4"
